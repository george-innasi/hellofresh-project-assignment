...
export default function IngredientFeedback() {
  ...
  const credit = (bad.length * 3.6).toFixed(2);
                ...
                <>
                  ...
                  <div style={{ background: C.amberBg, border: `1px solid ${C.amber}44`, borderRadius: 14, padding: 16, marginTop: 6 }}>
                    ...
                    <div style={{ fontSize: 13, color: C.black, lineHeight: 1.65 }}>
                      We've sent this straight to our quality team to review with the supplier{bad.length > 1 ? "s" : ""}. A <strong>${credit} credit</strong> has been applied to your account automatically.
                    </div>
                  </div>
                </>
              ) : (
